...
"""
    ...
    This telescope only has P1 mirror segments
"""
class PSCT_P1(Telescope):
    def __init__(self, config):
        ...
        self.panels = self.P1s[:self.n_panels] if "panels" not in telescope_config else telescope_config["panels"]
        self.true_centroids = np.zeros((self.n_panels, 2), dtype=float) # (total # of panels, 2) these are in fp coords
