...
"""
class EverythingDictWithOneHotPanelIDs(BaseFeaturesExtractor):
    ...
    def __init__(self, observation_space, config):
        ...
        features_dim_2=observation_space["current_panel_id"].shape[0]

        super().__init__(
            observation_space,
            features_dim=features_dim_1 + features_dim_2
        )
        ...
        self.final_norm = nn.LayerNorm(features_dim_1)
    ...
    def forward(self, observations):
        ...
        features = torch.cat((features, id), dim=1)
