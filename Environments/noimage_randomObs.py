...
""" 
    ...
    true centroid location for each centroid, and an action space that is
    just an (rx, ry). A list of active panels is maintained and incremented over
    every 'memory_time' amount of steps, and the action from the agent
    rotates whatever panel is currently selected.
"""
