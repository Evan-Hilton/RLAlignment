...
from configs.telescope.phaseTwoTelescope import telescopeConfig
...
config = {
    ...
    "train_config": {
        ...
        "tensorboard_log": "runs/phaseTwo/06-04-2026_16PanelBasicImage/",
        "policy_kwargs": dict(
            net_arch=dict(
    ...
    "model_save_path": "runs/phaseTwo/06-04-2026_16PanelBasicImage/agent"
}