...
from configs.experiments.phaseOne.d06_02_26_twoPanelBasicCNNConfig import config as two_panel_cnn_config
...
config["train_config"]["tensorboard_log"] = "runs/phaseOne/06-02-2026_twoPanelTwoFrameMemoryWithDiff/"
config["model_save_path"] = "runs/phaseOne/06-02-2026_twoPanelTwoFrameMemoryWithDiff/agent"
